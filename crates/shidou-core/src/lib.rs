...
//! Shidou's daemon-side core.
//!
//! Provider, database, filesystem, and Git implementations live here, behind
//! the transport-neutral contract in `shidou-protocol`. Client applications
//! intentionally depend on `shidou-client` instead of this crate.
...
pub use server::{Backend, EventSink, RuntimeEventOutcome, ServerOptions, serve};
