...
const ENDPOINT: Option<&str> = option_env!("SHIDOU_ANALYTICS_ENDPOINT");
#[cfg(debug_assertions)]
const ENDPOINT: Option<&str> = None;

#[cfg(not(debug_assertions))]
const WEBSITE_ID: Option<&str> = option_env!("SHIDOU_ANALYTICS_WEBSITE_ID");
#[cfg(debug_assertions)]
...
fn analytics_available() -> bool {
    !cfg!(debug_assertions)
        && !env_flag("SHIDOU_DISABLE_ANALYTICS")
