...
import type { Project, ProviderKind, SkillEntry, SkillSource } from '@shidou/client'
...
import { ProviderIcon, providerMeta, ShidouIcon } from '@/components/shidou-icon'
      ...
      <div className="grid h-full place-items-center px-10 py-10 text-center">
        <div>
          <div className="mx-auto grid size-11 place-items-center rounded-xl bg-[var(--inset)]">
            <ShidouIcon className="size-5 text-[var(--text-tertiary)]" name="package" />
          </div>
        ...
        {selected ? (
          ...
          <div className="grid h-full place-items-center text-[11px] text-[var(--text-ghost)]">
            <div className="flex flex-col items-center gap-2">
              <ShidouIcon className="size-5" name="package" />
      ...
      <div className="mx-auto max-w-[680px]">
        ...
        {skill.duplicates > 0 && (
          <div className="mt-3 flex items-center gap-1.5 text-[10px] text-[var(--warning)]">
            <ShidouIcon className="size-[11px]" name="alert" />
        ...
        <div className="mt-4 flex flex-wrap items-center gap-[7px]">
          ...
          >
            <ShidouIcon className="size-[11px]" name={copyFeedback.copied ? 'check' : 'copy'} />
          ...
          >
            <ShidouIcon className="size-[11px]" name="trash" /> {t(deleteArmed ? 'skills.confirm_delete' : 'skills.delete')}
          </Button>
        </div>
...
function SkillGlyph({ skill, enabled, large = false }: { skill: SkillEntry; enabled: boolean; large?: boolean }) {
  ...
  return <ShidouIcon className={cn(className, 'text-[var(--text-secondary)]')} name="package" />
}
