...
export function CodeFileSurface({
  ...
  return (
    <EditProvider createEditor={createFileEditor}>
      ...
      >
        <DiffsFile
          className="shidou-code-editor shidou-code-surface h-full min-h-full min-w-full bg-card"
          disableWorkerPool
          edit
...
function CodeDiffSurfaceContent({
  ...
  return (
    <div className="relative size-full min-h-0 min-w-0 bg-background">
      ...
      <CodeView
        className="shidou-code-surface size-full overflow-auto bg-background"
        disableWorkerPool={disableWorkerPool}
        items={model.items}
        options={options}
        ref={codeView}
